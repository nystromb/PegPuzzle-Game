...
public class PegPuzGameModel {
	...
	protected int startMoveLoc;
	protected int midLoc;
	
	private GamePlayableBoard board = new GamePlayableBoard();
	...
	public PegPuzGameModel(HexModel model){
	...
	public void newGame(){
		...
		for(int loc = 2; loc <= board.getMaxLoc(); loc++){
	...
	public boolean isGameOver(){
		boolean result = true;
		for(int loc = 1; loc <= board.getMaxLoc(); loc++){
